...
namespace Serialization {
    ...
    inline const char *EnumNamePortDirection(PortDirection e) {
        if (flatbuffers::IsOutRange(e, PortDirection::BT_INPUT, PortDirection::BT_INOUT)) return "";
        const size_t index = static_cast<size_t>(e);
    ...
    public:
        ...
        StatusChange(uint16_t _uid, Serialization::NodeStatus _prev_status, Serialization::NodeStatus _status,
    ...
    struct TreeNode FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
        ...
        const flatbuffers::Vector<flatbuffers::Offset<Serialization::PortConfig>> *port_remaps() const {
            return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Serialization::PortConfig>> *>(
                    VT_PORT_REMAPS);
        }
    ...
    struct BehaviorTree FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
        ...
        const flatbuffers::Vector<flatbuffers::Offset<Serialization::NodeModel>> *node_models() const {
            return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Serialization::NodeModel>> *>(
                    VT_NODE_MODELS);
        }
    ...
    inline flatbuffers::Offset<BehaviorTree> CreateBehaviorTreeDirect(
        ...
        auto node_models__ = node_models ? _fbb.CreateVector<flatbuffers::Offset<Serialization::NodeModel>>(
                *node_models) : 0;
    ...
    struct StatusChangeLogBuilder {
        ...
        void
        add_state_changes(flatbuffers::Offset<flatbuffers::Vector<const Serialization::StatusChange *>> state_changes) {
    ...
    inline flatbuffers::Offset<StatusChangeLog> CreateStatusChangeLogDirect(
        ...
        auto state_changes__ = state_changes ? _fbb.CreateVectorOfStructs<Serialization::StatusChange>(*state_changes)
                                             : 0;
